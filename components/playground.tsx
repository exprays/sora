          ...
          <Drawer>
            ...
            <DrawerContent className="max-h-[80vh]">
              <DrawerHeader>
                ...
                <DrawerDescription>Configure the settings for the database.</DrawerDescription>
              </DrawerHeader>
                      ...
                      <SelectContent>
                        <SelectItem value="genesis">
                          <div className="flex items-start gap-3 text-muted-foreground">
                            ...
                            <div className="grid gap-0.5">
                              <p>
                                Orion <span className="font-medium text-foreground">DB</span>
                              </p>
                              <p className="text-xs" data-description>
                                Fastest in-memory data structure store.
                              </p>
                            </div>
                          </div>
                        </SelectItem>
                        <SelectItem value="explorer">
                          <div className="flex items-start gap-3 text-muted-foreground">
                            ...
                            <div className="grid gap-0.5">
                              <p>
                                Bolt <span className="font-medium text-foreground">DB</span>
                              </p>
                              <p className="text-xs" data-description>
                                SQL Performance and speed for efficiency.
                              </p>
                            </div>
                          </div>
                        </SelectItem>
                        <SelectItem value="quantum">
                          <div className="flex items-start gap-3 text-muted-foreground">
                            ...
                            <div className="grid gap-0.5">
                              <p>
                                FlashX <span className="font-medium text-foreground">Quantum</span>
                              </p>
                              <p className="text-xs" data-description>
                                The most powerful document database ever.
                              </p>
                            </div>
                          </div>
                        </SelectItem>
          ...
          <div className="relative hidden flex-col items-start gap-8 md:flex" x-chunk="dashboard-03-chunk-0">
            <form className="grid w-full items-start gap-6">
              <fieldset className="grid gap-6 rounded-lg border p-4">
                ...
                <div className="grid gap-3">
                  <Label htmlFor="temperature">Region</Label>
                  <Input id="temperature" type="number" placeholder="India" disabled/>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-3">
                    <Label htmlFor="top-p">Protocol</Label>
                    <Input id="top-p" type="number" placeholder="REST" disabled/>
                  </div>
                  <div className="grid gap-3">
                    <Label htmlFor="top-k">Version</Label>
                    <Input id="top-k" type="number" placeholder="1.0.0" disabled/>
                  </div>
                </div>
              </fieldset>
              <fieldset className="grid gap-6 rounded-lg border p-4">
                ...
                <div className="grid gap-3">
                  ...
                  <Input id="provider" placeholder="AWS" disabled/>
                </div>
                <div className="grid gap-3">
                  <Label htmlFor="content">Content</Label>
                  <Textarea id="content" placeholder="Connected to database at thestarsociety.v3.aws.amazonaws.com/orion/instances/8738920208" className="min-h-[9.5rem]" disabled/>
                </div>
              </fieldset>
            </form>
          </div>
